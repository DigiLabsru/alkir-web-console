...
from ..data.create_cluster_admin import create_cluster_admin
from ..data.del_cluster_admin import del_cluster_admin
from ..data.gen_table_method.get_cluster_admins import get_cluster_admins
...
async def del_agent_admins(table, connect_info, del_button):
    ...
    for one_agent_admin_to_del in agent_admin_to_del:
        try:
            await run.io_bound(del_cluster_admin, remove_admin_name=one_agent_admin_to_del['name'], connect_info=connect_info)
