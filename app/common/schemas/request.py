...
class NewWorkingServer(BaseRequest):
    ...
    safe_call_memory_limit: int = Field(title='the safe memory size limit per call (in bytes)', description=0)
    safe_working_processes_memory_limit: int = Field(title='the safe memory size limit per working process on a server', description=0)
    ...
    temporary_allowed_processes_total_memory_time_limit: int = Field(title='the maximum time for working processes and cluster managers to excess temporary allowed memory size', description=0)
    working_process_memory_limit: int = Field(title='the maximum memory size available to processes', description=0)
